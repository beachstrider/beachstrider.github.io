          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">kaleb.mc.tech@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="p-8 shadow-xl backdrop-blur-lg bg-white/5 rounded-2xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center w-full px-6 py-3 space-x-2 font-semibold text-white transition-opacity rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90"
                >
